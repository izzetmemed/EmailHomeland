...
{
    public partial class MyDbContextMain : DbContext
    {
        public MyDbContextMain()
        {
        }

        public MyDbContextMain(DbContextOptions<MyDbContextMain> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=HomeLand;Integrated Security=True;Trust Server Certificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Land>(entity =>
            {
                ...
                entity.Property(e => e.DeleteId).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<LandCustomer>(entity =>
            {
                ...
                entity.Property(e => e.IsTake).HasDefaultValueSql("((0))");
